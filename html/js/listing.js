...
(function () {
  ...
  function cardHtml(p) {
    ...
    <div class="product-card">
      ...
      <button type="button" class="dh-cart-add-btn" data-slug="${p.slug}" data-name="${String(p.name).replace(/"/g, "&quot;")}" data-size="${p.size || ""}" data-price="${p.price}" data-image="${p.img}" aria-label="Thêm ${String(p.name).replace(/"/g, "&quot;")} vào giỏ hàng">
